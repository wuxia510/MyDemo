package com.wuxia.mydemo.views;
...
/**
 * 作者： Administrator on 2017/11/9 0009 12:48
...
public class CircularRevealLayout extends FrameLayout {
    ...
    public static class Builder {
        ...
        public Animator create() {
            ...
            layout.addView(view, new ViewGroup.LayoutParams(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.MATCH_PARENT));
